...
// Update your tablename here
	        ...
	        //SQL插入語法改寫到網頁上直接新增
	        //$sql = "INSERT INTO demo (id,area_id,sensor_id,buzzer,sensor1, sensor2, date, time) VALUES ('".$id."','".$area_id."','".$buzzer."','".$id."','".$sensor1."','".$sensor2."', '".$d."', '".$t."')"; 
            
            //SQL更新語法
            $sql = "UPDATE demo SET id='".$id."', area_id ='".$area_id."', sensor_id='".$sensor_id."', buzzer='".$buzzer."', sensor1='".$sensor1."', sensor2 ='".$sensor2."', date ='".$d."', time ='".$t."' WHERE id='".$id."' ";
